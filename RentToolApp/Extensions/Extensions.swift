...
extension UIViewController {
    func showCustomAlert(title: String, message: String, withOkButton: Bool = true, isError: Bool = false) {
        let alert = RTAlertController(title: title, message: message, isError: isError)
        if withOkButton {
    ...
    func showTemporarilyAlert(title: String, message: String, isError: Bool = false, duration: TimeInterval = 2.0) {
        let alert = RTAlertController(title: title, message: message, isError: isError)
